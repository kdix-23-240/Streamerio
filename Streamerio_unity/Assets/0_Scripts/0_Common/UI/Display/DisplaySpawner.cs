...
namespace Common.UI.Display
{
    ...
    /// </summary>
    public interface IDisplaySpawner
    {
        /// <summary>
    ...
    /// </summary>
    public class DisplaySpawner : IDisplaySpawner
    {
        /// <summary>
        ...
        public DisplaySpawner(IDisplayRepository repository, Transform parent, LifetimeScope parentScope)
        {
        ...
        public TDisplay Spawn<TDisplay>()
            where TDisplay : IDisplay
        {
